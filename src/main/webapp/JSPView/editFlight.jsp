...
<%@ page import="java.util.*,Model.Flight,DAO.flightDAO" %>
...
// Get flight ID from request
    ...
    if(flightIDStr != null && !flightIDStr.isEmpty()) {
        try {
            ...
            response.sendRedirect("JSPView/manageFlight.jsp"); // Invalid ID
        }
    } else {
        response.sendRedirect("JSPView/manageFlight.jsp"); // No ID provided
    }

    if(flight == null) {
        response.sendRedirect("JSPView/manageFlight.jsp"); // Flight not found
    }

    // Fetch Airlines and Aircrafts
    ...
    try {
        ...
        while(rsAirline.next()){
            ...
            a.put("id", String.valueOf(rsAirline.getInt("airlineID")));
        ...
        while(rsAircraft.next()){
            Map<String,String> a = new HashMap<>();
            a.put("id", String.valueOf(rsAircraft.getInt("aircraftID")));
...
<head>
  ...
  <title>Edit Flight | Aurora Admin</title>
...
<div class="container">
  <div class="admin-panel">
    ...
    <div class="content">
        ...
        <table id="flightTable" class="flight-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="${pageContext.request.contextPath}/viewFlight.jsp?id=<%= f.getFlightID() %>" class="btn btn-view"><i class="fa-regular fa-eye"></i></a>
                <a href="${pageContext.request.contextPath}/editFlight.jsp?id=<%= f.getFlightID() %>" class="btn btn-edit"><i class="fa-regular fa-pen-to-square"></i></a>
                <a href="${pageContext.request.contextPath}/deleteFlight?id=<%= f.getFlightID() %>" class="btn btn-delete" onclick="return confirm('Are you sure to delete this flight?');"><i class="fa-solid fa-trash"></i></a>
              </td>
            </tr>
            <% } %>
          </tbody>
      ...
      <input type="hidden" name="action" value="editFlights"/>
          ...
          <div class="modal-content">
            ...
            <div class="row">
              <div class="form-group">
                ...
                <input type="text" name="flightNumber" value="<%= flight.getFlightNumber() %>" required>
              </div>
          </div>
            ...
            <div class="row">
              <div class="form-group">
                ...
                <select name="origin" id="origin" required>
                  ...
                  <option <%= "Yangon".equals(flight.getOrigin()) ? "selected" : "" %>>Yangon</option>
                  <option <%= "Mandalay".equals(flight.getOrigin()) ? "selected" : "" %>>Mandalay</option>
                  <option <%= "Naypyitaw".equals(flight.getOrigin()) ? "selected" : "" %>>Naypyitaw</option>
                  <option <%= "Bagan".equals(flight.getOrigin()) ? "selected" : "" %>>Bagan</option>
                  <option <%= "Tachileik".equals(flight.getOrigin()) ? "selected" : "" %>>Tachileik</option>
                </select>
              </div>
              <div class="form-group">
                ...
                <select name="destination" id="destination" required>
                  ...
                  <option <%= "Yangon".equals(flight.getDestination()) ? "selected" : "" %>>Yangon</option>
                  <option <%= "Mandalay".equals(flight.getDestination()) ? "selected" : "" %>>Mandalay</option>
                  <option <%= "Naypyitaw".equals(flight.getDestination()) ? "selected" : "" %>>Naypyitaw</option>
                  <option <%= "Bagan".equals(flight.getDestination()) ? "selected" : "" %>>Bagan</option>
                  <option <%= "Tachileik".equals(flight.getDestination()) ? "selected" : "" %>>Tachileik</option>
                </select>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group">
                ...
                <input type="datetime-local" name="departureTime" value="<%= flight.getDepartureTime().toString().replace(" ", "T") %>" required>
              </div>
              <div class="form-group">
                <label>Arrival</label>
                <input type="datetime-local" name="arrivalTime" value="<%= flight.getArrivalTime().toString().replace(" ", "T") %>" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="form-group">
                <label>Price</label>
                <input type="number" name="price" value="<%= flight.getPrice() %>" required>
              </div>
              <div class="form-group">
                <label>Seats</label>
                <input type="number" name="availableSeats" value="<%= flight.getAvailableSeats() %>" required>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <select name="aircraftID" required>
                  ...
                  <% for(Map<String,String> a : aircrafts){ %>
                      <option value="<%=a.get("id")%>" <%= a.get("id").equals(String.valueOf(flight.getAircraftID())) ? "selected" : "" %>><%=a.get("model")%></option>
                  <% } %>
                </select>
              </div>
              <div class="form-group">
                ...
                <select name="airlineID" required>
                  ...
                  <% for(Map<String,String> a : airlines){ %>
                      <option value="<%=a.get("id")%>" <%= a.get("id").equals(String.valueOf(flight.getAirlineID())) ? "selected" : "" %>><%=a.get("name")%></option>
                  <% } %>
                </select>
              </div>
            </div>
...
<script>
  function goToManage() { window.location.href = "JSPView/manageFlight.jsp"; }
  ...
  window.onload = function() {
    ...
    originSelect.addEventListener("change", function() {
      ...
      Array.from(destinationSelect.options).forEach(option => {
        option.disabled = (option.value === selectedOrigin && selectedOrigin !== "");
      });
    });
  }
</script>
